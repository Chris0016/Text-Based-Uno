	        ...
	        if ((UnoDeck.tC.substring(1)).equals("Plus_2") || (UnoDeck.tC.substring(0)).equals("Plus_4") ){
	            ...
	            UnoDeck.tC = "Plus_none";
	             if ((player1.get(0)).equals("James") || (player1.get(0)).equals("Alex")){
	                 ...
	                 System.out.println(player1.get(0)+ " picked up " +UnoDeck.lastCard(UnoDeck.playedDeck).substring((UnoDeck.lastCard(UnoDeck.playedDeck)).length()-1) +" cards");
	            }
	           
	            else{
	                System.out.println("Picked up "+ UnoDeck.lastCard(UnoDeck.playedDeck).substring((UnoDeck.lastCard(UnoDeck.playedDeck)).length()-1)+ " cards.");
	            }
